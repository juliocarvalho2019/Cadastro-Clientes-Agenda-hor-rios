...
public class ClienteDAO {
    ...
    public void save(Cliente cliente) {
        try {
            PreparedStatement ps = connection.prepareStatement("INSERT INTO clientes (nome, email, sexo, telefone, rua, numero, bairro, imagem) VALUES (?,?,?,?,?,?,?,?)");
            ...
            ps.setString(8, cliente.getImagem());
            ps.execute();
    ...
    public void update(Cliente cliente) {
        try {
            PreparedStatement ps = connection.prepareStatement("UPDATE clientes SET  nome=?, email=?, sexo=?, telefone=?, rua=?, numero=?, bairro=? WHERE id=?");
            ps.setString(1, cliente.getNome());
            ps.setString(2, cliente.getEmail());
            ps.setString(3, cliente.getSexo());
            ps.setString(4, cliente.getTelefone());
